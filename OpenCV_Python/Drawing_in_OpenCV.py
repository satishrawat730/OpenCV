...
Draw primitive over image
    Line, Arrowed Line, Rectangle, Circle, Text
'''
...
# straight Line( image file, begin point, end point, color(BGR), line thickness)
...
'''
# draw rectangle(img, point1, point2, color, thickness, lineType, shift=None)
...
# draw text : putText(img, text, origin point, fontFace, fontScale, color, thickness=None,
